class Week < ActiveRecord::Base
  ...
  validate :no_dups_standings, :no_nil_standings, :valid_retier, :valid_nr_of_registered_teams, :valid_nr_of_cycles
  ...
  def valid_retier
    ...
    settings.each_with_index { |setting, tier|
      teams_down = setting ? setting.teams_down.to_i : 0
      total_teams = setting ? setting.total_teams.to_i : 0
